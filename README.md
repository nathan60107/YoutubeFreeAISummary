...
- **Custom prompt** — Rewrite the prompt sent to the AI in the settings dialog; leave it blank to follow the interface language and use that language's default prompt
